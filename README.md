...
<img src="./images/Screenshot_2025-02-18_225532.png" alt="Composer" width="65%"/>
...
1. Compilar y empaquetar el código java utilizando Maven
    ...
    mvn clean package
    ```
   <img src="./images/maven.png" alt="maven" width="65%"/>

1. Crear un bucket S3 donde el código fuente estará almacenado
    ```
    aws s3 mb s3://arquitectopaul123
    ```
   <img src="./images/Screenshot_2025-02-18_193833.png" alt="Composer" width="65%"/>
   
   <img src="./images/Screenshot_2025-02-18_193902.png" alt="Composer" width="65%"/>

1. Copiar el código fuente localizado en el folder target
    ```
    aws s3 cp target/sourceCode.zip s3://arquitectopaul123
    ```
   <img src="./images/maven3.png" alt="maven3" width="65%"/>
...
1. Desplegar la pila CloudFormation
    ...
    ```
   <img src="./images/sam.png" alt="sam" width="65%"/>
   
   <img src="./images/sam2.png" alt="sam2" width="65%"/>
...
Los registros capturados por Kinesis Data Streams son ingeridos por Kinesis Data Firehose y se almacenan como objetos en un bucket de S3. 
   ...
   <img src="./images/Screenshot_2025-02-18_194457.png" alt="Composer" width="65%"/>
...
```
   ...
   <img src="./images/kinesis.png" alt="kinesis" width="65%"/>

   <img src="./images/Screenshot_2025-02-18_193647.png" alt="Composer" width="65%"/>

   <img src="./images/Screenshot_2025-02-18_194213.png" alt="Composer" width="65%"/>

Listar los objetos S3
```
aws s3 ls s3://arquitectopaul123 --recursive --human-readable --summarize
```
   <img src="./images/S3.png" alt="S3" width="65%"/>
...
----
   ...
   <img src="./images/delete.png" alt="delete" width="65%"/>
